...
id_usuario, nome_usuario, email, telefone, senha, idade, status, biografia.

- **Servidor**

id_servidor, nome, descriçao, data_criacao, fk id_proprietario.

- **Membro_servidor**

id_membro_servidor, fk id_usuario, fk id_servidor.

- **Canal**

id_canal, nome, tipo, descricao, fk id_servidor.
...
id_mensagem, conteudo, data_criaçao, fk id_usuario, fk id_canal, fk id_conversa, fk id_mensagem_resposta.

- **Solicitacao_amizade**

id_solicitacao, status, data_envio, fk id_remetente, fk id_destinatario.

- **Amizade**

data_inicio, fk id_usuario_1, fk id_usuario_2.

- **Cargo_servidor**

id_cargo_servidor, nome, cor, hierarquia, fk id_servidor.

- **Reacao_mensagem**

emoji, data_reacao, fk id_usuario, fk id_mensagem.
...
- O usuário deve possuir idade, que não deve ser negativa.
...
- Uma ou mais mensagens podem ser resposta de uma outra mensagem, mas uma mensagem nao pode responder varias outras ao mesmo tempo.

### Amizade e Solicitçao
...
- A solicitaçao deve possuir um identificador unico.

### Cargo

- O cargo de um servidor deve possuir um identificador unico.
